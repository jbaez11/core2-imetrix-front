...
export default function EditarBorrarCustomer(){

	/*=============================================
	HOOK para capturar datos
	=============================================*/

	const [customer, editarCustomer ] = useState({
	...
	const submitPut = async e => {
		...
		const {imagen, titulo, descripcion, id} = customer;
		...
		if(descripcion !== ""){
			...
			const expDescripcion = /^([0-9a-zA-Z ]).{1,500}$/;
		...
		const result = await putData(customer);
		...
		if(result.status === 200){
			...
			setTimeout(()=>{window.location.href= "/customerinsights";},3000)
	...
	$(document).on("click", ".editarInputs", function(e){
		...
		$("#editarId").val(data[0]);
		$(".previsualizarImg").attr("src", `${rutaAPI}/mostrar-img-customer/${data[1]}`)
	...
	return(
		...
		<div className="modal fade" id="editarCustomer">
			...
			<div className="modal-dialog">
				...
				<div className="modal-content">
					...
					<div className="modal-header">
						<h4 className="modal-title">Editar Solucion</h4>
...
/*=============================================
PETICIÓN PUT Customer
=============================================*/

const putData = data =>{

	const url = `${rutaAPI}/editar-customer/${data.id}`;
...
/*=============================================
PETICIÓN DELETE Customer
=============================================*/

const deleteData = data =>{

	const url = `${rutaAPI}/borrar-customer/${data}`;
	const token = localStorage.getItem("ACCESS_TOKEN");
	const params = {
