...
export default function CrearCustomer(){
	...
	const [customer, crearCustomer] = useState({
	...
	const submitPost = async e => {
		...
		const {imagen, titulo, descripcion} = customer;

		/*=============================================
		Validamos si no viene imagen Customer
		=============================================*/
		...
		const result = await postData(customer);
    ...
    return(
        <div className="modal fade" id="crearCustomer">
			...
			<div className="modal-dialog">
				...
				<div className="modal-content">
					...
					<div className="modal-header">
						<h4 className="modal-title">Crear Customer</h4>
...
//peticion post customer
const postData = data =>{
	const url = `${rutaAPI}/crear-customer`;
