...
export default function CrearIntro(){

    /*=============================================
	HOOK para capturar datos
	=============================================*/

	const [intro, crearIntro] = useState({
	...
	const submitPost = async e => {
		...
		const {imagen, titulo, descripcion} = intro;

		/*=============================================
		Validamos si no viene imagen intro
		=============================================*/
		...
		const result = await postData(intro);
    ...
    return(
        <div className="modal fade" id="crearIntro">
			...
			<div className="modal-dialog">
				...
				<div className="modal-content">
					...
					<div className="modal-header">
						<h4 className="modal-title">Crear Solucion</h4>
