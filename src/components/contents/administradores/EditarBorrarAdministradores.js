...
export default function EditarAdministradores(){
	...
	$(document).on("click", ".borrarInput", function(e){
		...
		//preguntar primero si desea eliminar
		      ...
		      <form onChange={cambiaFormPost} onSubmit={submitPost}> 
			      ...
			      <div className="modal-body">
			      	...
			      	<div className="form-group">
			      		...
			      		<label className="small text-secondary" htmlFor="editarUsuario">*Mínimo 2 caracteres, máximo 18, sin números</label>
			      ...
			      <div className="modal-footer d-flex justify-content-between">
				      ...
				      <div><button type="submit" className="btn btn-warning">Enviar</button></div>        
