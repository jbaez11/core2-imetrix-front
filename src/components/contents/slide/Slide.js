...
import EditarBorrar from './EditarBorrarSlide';
	...
	const dataSlide = async()=>{
		// crear el dataset para datatables
			...
			getSlide.data.forEach((slide,index)=>{
				dataSet[index] = [(index+1),slide.imagen,slide.titulo,slide.descripcion,[
					slide._id+'_',
					slide.imagen+'_',
					slide.titulo+'_',
					slide.descripcion,
				...
				<div className="container-fluid">
					...
					<div className="row mb-2">
						...
						<div className="col-sm-6">
							...
							<h1 className="m-0 text-dark">Gestor de soluciones</h1>
						...
						<div className="card card-warning card-outline">
							...
							<div className="card-header">
								...
								<h5 className="m-0">
									...
									<button className="btn btn-warning limpiarFormulario" data-toggle="modal" data-target="#crearSlide">Crear nueva solucion</button>
